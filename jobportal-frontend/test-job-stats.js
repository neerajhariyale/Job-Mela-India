...
async function testJobStatsAPI() {
  try {
    ...
    const statsResponse = await axios.get('https://job-mela-india-production.up.railway.app/api/jobs/stats');
    ...
    const chartResponse = await axios.get('https://job-mela-india-production.up.railway.app/api/jobs/chart-stats?timeRange=7d');
